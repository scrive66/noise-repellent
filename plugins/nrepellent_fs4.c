...
#define NOISEREPELLENT_URI "https://github.com/lucianodato/noise-repellent#nrepellent_fs4"
#define NOISEREPELLENT_STEREO_URI                                              \
  "https://github.com/lucianodato/noise-repellent#nrepellent_fs4-stereo"
