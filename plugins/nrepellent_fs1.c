...
#define NOISEREPELLENT_URI "https://github.com/lucianodato/noise-repellent#nrepellent_fs1"
#define NOISEREPELLENT_STEREO_URI                                              \
  "https://github.com/lucianodato/noise-repellent#nrepellent_fs1-stereo"
